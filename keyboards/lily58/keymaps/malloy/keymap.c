 ...
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LCtl | LGUI |RAISE | /LShft /       \ Spc  \  |LOWER | RCtl |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LALT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, XXXXXXX ,  KC_ENT,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                        KC_LCTL, KC_LGUI, MO(_RAISE), KC_LSFT, KC_SPC, MO(_LOWER), KC_RCTL,XXXXXXX
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
...
[_RAISE] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                   KC_HOME, KC_PGDN, KC_PGUP,KC_END, XXXXXXX, KC_EQL ,
...
/* GAMING - toggle via TG(_GAMING) on ADJUST layer (backspace position)
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * | ESC  |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |BackSP|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Tab  |   Q  |   W  |   E  |   R  |   T  |                    |   Y  |   U  |   I  |   O  |   P  |  -   |
 ...
 * | LAlt |   Z  |   X  |   C  |   V  |   B  |-------|    |-------|   N  |   M  |   ,  |   .  |   /  |Enter |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *                   | LCtl | XXXX | XXXX | /LShft /       \ Spc  \  |ADJ   | RCtl |      |
 *                   |      |      |      |/       /         \      \ |      |      |      |
 *                   `----------------------------'           '------''--------------------'
 */
  [_GAMING] = LAYOUT(
  ...
  KC_LSFT, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,  XXXXXXX, KC_ENT,  KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT,
                   KC_LCTL, KC_SPC, XXXXXXX, KC_LSFT, KC_SPC, MO(_ADJUST), KC_RCTL, XXXXXXX
  )
};
